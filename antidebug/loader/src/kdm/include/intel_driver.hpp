...
namespace intel_driver
{
	...
	// antidebug: identity-injected pool tag - 'BwtE' is a known
	// mapper fingerprint in the upstream tree（docs/06 §6）.
#ifndef ADBG_POOL_TAG
#define ADBG_POOL_TAG 'Adbg'
#endif
	inline ULONG32 g_pool_tag = ADBG_POOL_TAG;
	// WdFilter trace cleanup is off by default: tampering with Defender
	// internals exceeds cleaning up the loader's own traces.
	inline bool g_clear_wd_filter_list = false;
